                            ...
                            <section class="card card-body mb-0">
                                ...
                                <div class="accordion accordion-with-radio" id="accordionExample">
                                    <div class="accordion-item">
                                            ...
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="paymentFlexRadioDefault" checked
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse show collapse"
...
<script src="{{ asset('admin/libs/bundle.js')}}"></script>
 <!-- Form wizard -->
 <script src="{{ asset('admin/libs/form-wizard/jquery.steps.min.js') }}"></script>

 <!-- Examples -->
 <script src="{{ asset('admin/dist/js/examples/checkout.js') }}"></script>
